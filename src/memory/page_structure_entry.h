...
/**
 * Bitmask definitions for each memory map page-structure entries.
 *
 ...
 * entry.
 *
 * Refer to section 4.5 of Intel 64 and IA-32 architectures software developer's manual for detailed
 * description.
 */
