...
/**
 * Definitions of entries of the memory map page structures.
 *
 ...
 * Present flag.
 *
 * The processor seeks next page structure if this bit is set.
 *
 * Otherwise, the processor generates page fault exception.
 */
#define PAGE_STRUCTURE_ENTRY_PRESENT (0x0000000000000001)
/**
 * Read/write flag.
 *
 * If unset, writes are not be allowed to the region controlled by this entry.
 */
#define PAGE_STRUCTURE_ENTRY_READ_WRITE (0x0000000000000002)
/**
 * User/supervisor flag.
 *
 * If unset, user-mode accesses are not allowed to the region controlled by this entry.
 */
#define PAGE_STRUCTURE_ENTRY_USER_SUPER (0x0000000000000004)
/**
 * Page-level write-through flag.
 *
 * Indirectly determines the memory type used to access the next page structure referenced by this
 * entry.
 *
 * @see Section 4.5, Intel 64 and IA-32 architectures software developer's manual
 */
#define PAGE_STRUCTURE_ENTRY_CACHE_WRITE_THROUGH (0x0000000000000008)
/**
 ...
 * @see Section 4.5, Intel 64 and IA-32 architectures software developer's manual
 */
#define PAGE_STRUCTURE_ENTRY_CACHE_DISABLED (0x0000000000000010)
/**
 * Accessed flag.
 *
 * Indicates whether this entry has been used for linear-address translation.
 */
#define PAGE_STRUCTURE_ENTRY_ACCESSED (0x0000000000000020)
/**
 * Dirty flag.
 *
 ...
 */
#define PAGE_STRUCTURE_ENTRY_PAGE_SIZE (0x0000000000000080)
/**
...
/**
 * Physical address of next page structure referenced by this entry.
 *
 ...
 */
#define PAGE_STRUCTURE_ENTRY_BASE_ADDRESS          (0x000FFFFFFFFFF000)
#define PAGE_STRUCTURE_ENTRY_BASE_ADDRESS_RESERVED (0x000F000000000000)
/**
 ...
 * Reserved otherwise.
 */
#define PAGE_STRUCTURE_ENTRY_EXECUTION_DISABLED (0x8000000000000000)

#define PAGE_STRUCTURE_ENTRY_DEFAULT (PAGE_STRUCTURE_ENTRY_READ_WRITE)
